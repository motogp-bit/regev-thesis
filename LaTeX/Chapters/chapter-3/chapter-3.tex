...
Now,we have $O(n)$ qubits for the exponent register, another $O(n)$ for the function register \cite{Shor1997}, and $O(n)$ ancilla qubits for the modular exponentiation,addition and multiplication \cite{Roetteler2017}. That gives us a total of $O(3n) = O(n)$ qubits for space complexity.
