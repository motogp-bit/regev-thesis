...
This utilizes two calls to an out-of-place modular multiplication circuit and one to an in-place modular adder. More specifically, the out-of-place modular multiplication circuit performs
\begin{equation}
