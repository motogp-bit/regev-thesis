...
A potential implementation two calls to an out-of-place modular multiplication circuit and one to an in-place modular adder, so multiply ->add -> invert multiplication. The out-of-place modular multiplication circuit performs
\begin{equation}
