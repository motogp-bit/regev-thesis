...
The program code is available on \href{https://github.com/motogp-bit/regev-thesis}{github}.
...
The circuit from \eqref{eq13.4} could be implemented in the fashion outlined in \cite{Roetteler2017} using addition and reduction, or using a QFT-based adder, while the one in \eqref{eq13.3} can be customized to utilize any multiplication algorithm to adjust the qubit/gate tradeoff. 
