...
Suppose we restrict the value computer in \eqref{eq9.2} to being the product of only $j$ terms, with $j < d$. Then let $Vol_j(\Lambda)$ be the volume of the parallelepiped formed by the first j basis vectors.
