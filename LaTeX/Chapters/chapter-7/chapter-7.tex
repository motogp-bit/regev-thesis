...
Lastly, define the QFT over $\mathbb{Z}^d_D$, applied on some quantum state $\ket{x}$, is as follows:
\begin{equation}
...
Below we have pseudocode for the QFT over $Z^d_D$. We use the Hadamard gate H, which should be well known to the reader, and gates SWAP and CPR that perform the following statetransitions:
