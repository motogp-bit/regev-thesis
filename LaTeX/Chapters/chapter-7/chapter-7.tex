...
Below we prese t pseudocode for the QFT over $Z^d_D$. We use the Hadamard gate H, which should be well known to the reader, and gates SWAP and CPR that perform the following statetransitions:
